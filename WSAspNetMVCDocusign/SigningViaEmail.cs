...
namespace WSAspNetMVCDocusign
{
    public static class SigningViaEmail
    {
        ...
        public static string SendEnvelopeViaEmail(string signerEmail, string signerName, string signerEmail2, string signerName2, string signerEmail3, string signerName3, string accessToken, string basePath, string accountId, string docPdf, string envStatus)
        {
            ApiClient apiClient = new ApiClient(basePath);
            EnvelopeDefinition env = MakeEnvelope(signerEmail, signerName, signerEmail2, signerName2, signerEmail3, signerName3, docPdf, envStatus);
        ...
        private static EnvelopeDefinition MakeEnvelope(string signerEmail, string signerName, string signerEmail2, string signerName2, string signerEmail3, string signerName3, string docPdf, string envStatus)
        {
            ...
            string doc3PdfString = Convert.ToBase64String(new WebClient().DownloadData(docPdf));
           ...
           /* Document doc2 = new Document
            ...
            {
                AnchorString = "Responsável pela aprovação",
                AnchorUnits = "pixels",
                AnchorYOffset = "-28",
                AnchorXOffset = "0"
            };
            ...
            Tabs signer3Tabs = new Tabs
            {
                SignHereTabs = new List<SignHere> { signHere3 }
            };
            signer3.Tabs = signer3Tabs;

            // Add the recipients to the envelope object
            Recipients recipients = new Recipients
            {
                Signers = new List<Signer> { signer1, signer2, signer3 },
            };
